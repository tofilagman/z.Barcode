...
using z.Barcode.Aztec;
using z.Barcode.Datamatrix;
using z.Barcode.Maxicode;
using z.Barcode.OneD;
using z.Barcode.PDF417;
using z.Barcode.QrCode;
...
namespace z.Barcode
{
   ...
   /// <author>www.Redivivus.in (suraj.supekar@redivivus.in) - Ported from z.Barcode Java Source</author>
