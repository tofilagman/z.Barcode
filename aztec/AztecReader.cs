/*
 * Copyright 2010 z.Barcode authors
 *
...
using z.Barcode.Aztec.Internal;

namespace z.Barcode.Aztec
{
   /// <summary>
   ...
   public class AztecReader : Reader
   {
      ...
      /// </summary>
      /// <param name="image">image of barcode to decode</param>
      /// <param name="hints">passed as a {@link java.util.Hashtable} from {@link com.google.z.Barcode.DecodeHintType}
