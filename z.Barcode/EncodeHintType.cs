/*
* Copyright 2008 z.Barcode authors
*
...
namespace z.Barcode
{
   ...
   public enum EncodeHintType
   {
      ...
      /// <see cref="z.Barcode.QrCode.Internal.ErrorCorrectionLevel" />
      ...
      /// type: <see cref="z.Barcode.PDF417.Internal.Compaction" />
      /// </summary>
      PDF417_COMPACTION,

      /// <summary>
      /// Specifies the minimum and maximum number of rows and columns for PDF417.
      /// type: <see cref="z.Barcode.PDF417.Internal.Dimensions" />
      /// </summary>
      PDF417_DIMENSIONS,
      ...
      /// <summary>
      /// Specifies the matrix shape for Data Matrix (type {@link com.google.z.Barcode.datamatrix.encoder.SymbolShapeHint})
      /// </summary>
      DATA_MATRIX_SHAPE,
