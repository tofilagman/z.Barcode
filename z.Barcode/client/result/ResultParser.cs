/*
* Copyright 2007 z.Barcode authors
*
...
namespace z.Barcode.Client.Result
{
   /// <summary> <p>Abstract class representing the result of decoding a barcode, as more than
   /// a String -- as some type of structured data. This might be a subclass which represents
   /// a URL, or an e-mail address. {@link #parseResult(com.google.z.Barcode.Result)} will turn a raw
   ...
   public abstract class ResultParser
   {
      ...
      /// <returns></returns>
      public abstract ParsedResult parse(z.Barcode.Result theResult);

      public static ParsedResult parseResult(z.Barcode.Result theResult)
      {
