/*
* Copyright 2009 z.Barcode authors
*
...
namespace z.Barcode.Common
{
   ...
   /// a good general purpose binarizer for uses outside z.Barcode.
   /// 
   ...
   /// </author>
   /// <author>www.Redivivus.in (suraj.supekar@redivivus.in) - Ported from z.Barcode Java Source 
   /// </author>
   public sealed class HybridBinarizer : GlobalHistogramBinarizer
   {
      ...
      /// http://groups.google.com/group/z.Barcode/browse_thread/thread/d06efa2c35a7ddc0
      /// </summary>
      /// <param name="luminances">The luminances.</param>
      /// <param name="subWidth">Width of the sub.</param>
      /// <param name="subHeight">Height of the sub.</param>
