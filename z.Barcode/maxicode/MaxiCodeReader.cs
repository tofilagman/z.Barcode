/*
 * Copyright 2011 z.Barcode authors
 *
...
using z.Barcode.Common;
using z.Barcode.Maxicode.Internal;

namespace z.Barcode.Maxicode
{
   /// <summary>
   ...
   public sealed class MaxiCodeReader : Reader
   {
      ...
      /// case.
      ///
      /// @see com.google.z.Barcode.pdf417.PDF417Reader#extractPureBits(BitMatrix)
      /// @see com.google.z.Barcode.datamatrix.DataMatrixReader#extractPureBits(BitMatrix)
      /// @see com.google.z.Barcode.qrcode.QRCodeReader#extractPureBits(BitMatrix)
      /// </summary>
